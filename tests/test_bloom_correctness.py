...
class TestBloomCorrectness(ValkeyBloomTestCaseBase):
    ...
    def test_non_scaling_filter(self):
        ...
        new_item_idx = self.add_items_till_scaling_failure(client, filter_name, add_operation_idx, item_prefix)
        self.validate_scaling_failure(client, filter_name, item_prefix, new_item_idx)
